			...
			while(true){
				...
				*/
				...
				if (this.id == -1 && !this.registered){
					...
					board.installPlayer(this.id);                    //how to enable and install moderator?                             
					continue;
				}
				...
				*/
				...
				if (cmd == null){
					...
					client_quit = true;      //not sure
					quit = true;    
                       
					// release everything socket related
					 //output = null;  //not sure             
                    socket.close();
				...
				*/
				//https://stackoverflow.com/questions/15753869/implementing-a-cyclicbarrier-in-java-using-semaphores
